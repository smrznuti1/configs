...
#>
    ...
    begin {
        ...
        if ($Credential) {
            ...
            $PwPassword = $Credential.GetNetworkCredential().Password
        } else {
            $PwPassword = [System.Runtime.InteropServices.Marshal]::PtrToStringAuto([System.Runtime.InteropServices.Marshal]::SecureStringToBSTR($Password))
        }
    }
    process {
        foreach ($Computer in $ComputerName) {
            ...
            $ProcessInfo.Arguments   = "/generic:TERMSRV/$ComputerCmdkey /user:$User /pass:$PwPassword"
