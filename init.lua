...
require("mason-null-ls").setup {
    ensure_installed = {
        "lua-language-server", "texlab", "latexindent", "actionlint",
        "bibtex-tidy ", "commitlint", "debugpy",
        "docker-compose-language-service", "dockerfile-language-server",
        "fixjson", "gitleaks", "isort", "prettier", "pyflakes", "taplo",
        "yaml-language-server", "yamlfix", "cmakelang", "cmake-language-server",
        "bash-language-server ", -- "powershell-editor-services",
        "shellcheck", "beautysh", "ansible-language-server"
    },
